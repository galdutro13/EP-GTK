...
CREATE TABLE `pintura` (
  ...
  `Desenhada` varchar(45) NOT NULL,
  `Estilo` varchar(45) NOT NULL,
  PRIMARY KEY (`ID_pintura`),
  UNIQUE KEY `ID_pintura_UNIQUE` (`ID_pintura`),
  CONSTRAINT `fk_Pintura_Objeto_Arte` FOREIGN KEY (`ID_pintura`) REFERENCES `objetos_arte` (`num_ID`)
...
INSERT INTO `pintura` VALUES (2,'Sim','Cubismo');
