...
CREATE TABLE `outros` (
  ...
  UNIQUE KEY `ID_outros_UNIQUE` (`ID_outros`),
  CONSTRAINT `fk_Outros_Objeto_Arte1` FOREIGN KEY (`ID_outros`) REFERENCES `objetos_arte` (`num_ID`)
...
INSERT INTO `outros` VALUES (3,'HQ','Modernista');
